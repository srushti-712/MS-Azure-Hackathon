...
workspace_name = "AutoML_challenge1" # PLACEHOLDER
subscription_id = "e9698aad-d401-41a6-9249-78e771a1d033" # PLACEHOLDER
resource_group = "GGR_Hackathon" # PLACEHOLDER
experiment_name = "heart-disease-classification-3" # PLACEHOLDER
iteration = "8"  # PLACEHOLDER
run_id = "AutoML_52d93c56-c266-4371-bbb5-c8ec20d915f4_8"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':False,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'whitelist_models':None,'compute_target':'Compute-2','enable_dnn':True,'enable_code_generation':True,'experiment_exit_score':0.95,'experiment_timeout_minutes':45,'featurization':{'_blocked_transformers':[],'_column_purposes':{},'_dataset_language':'','_transformer_params':{'Imputer':[]},'_drop_columns':['target']},'hyperdrive_config':None,'dataset_id':'de49bc4b-a2cd-4b9e-b9b7-bc9dfd9b3dd0','grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':45,'max_concurrent_iterations':2,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'heart-disease-classification-3','path':'./sample_projects/heart-disease-classification-3','primary_metric':'accuracy','region':'eastus','resource_group':'GGR_Hackathon','subscription_id':'e9698aad-d401-41a6-9249-78e771a1d033','task_type':'classification','validation_size':0.1,'test_size':None,'vm_type':'STANDARD_DS11_V2','workspace_name':'AutoML_challenge1','label_column_name':'target','positive_label':None,'enable_batch_run':True,'save_mlflow':True} # PLACEHOLDER
pipeline_spec = "{\"objects\": [{\"class_name\": \"StandardScaler\", \"module\": \"sklearn.preprocessing\", \"param_args\": [], \"param_kwargs\": {\"with_mean\": false, \"with_std\": false}, \"prepared_kwargs\": {}, \"spec_class\": \"preproc\"}, {\"class_name\": \"ExtraTreesClassifier\", \"module\": \"sklearn.ensemble\", \"param_args\": [], \"param_kwargs\": {\"bootstrap\": false, \"class_weight\": null, \"criterion\": \"entropy\", \"max_features\": 0.05, \"min_samples_leaf\": 0.01, \"min_samples_split\": 0.01, \"n_estimators\": 25, \"oob_score\": false}, \"prepared_kwargs\": {}, \"spec_class\": \"sklearn\"}], \"pipeline_id\": \"79ebb3b8c385e3190e3dd4c1fa28b74730528045\", \"module\": \"sklearn.pipeline\", \"class_name\": \"Pipeline\", \"pipeline_name\": \"{ StandardScaler, ExtraTreesClassifier }\"}" # PLACEHOLDER
pipeline_id = "79ebb3b8c385e3190e3dd4c1fa28b74730528045" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"104f7be7-8d18-400b-afba-e40abbbb2909\"}}" # PLACEHOLDER
